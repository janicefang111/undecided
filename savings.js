...
D1_button.onclick = function() {
  ...
  progress.innerHTML = (parseFloat(collected_1.innerHTML.replace("$",""))
...
D2_button.onclick = function() {
  ...
  progress.innerHTML = (parseFloat(collected_2.innerHTML.replace("$",""))
...
D3_button.onclick = function() {
  ...
  progress.innerHTML = (parseFloat(collected_3.innerHTML.replace("$",""))
